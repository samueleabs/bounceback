 ...
 */
var SignaturePad = (function (a) {
	"use strict";
	var b = function (a, b) {
		var c = b || {};
		(this.velocityFilterWeight = c.velocityFilterWeight || 0.7),
			(this.minWidth = c.minWidth || 0.5),
			(this.maxWidth = c.maxWidth || 2.5),
			(this.dotSize =
				c.dotSize ||
				function () {
					return (this.minWidth + this.maxWidth) / 2;
				}),
			(this.penColor = c.penColor || "black"),
			(this.backgroundColor = c.backgroundColor || "rgba(0,0,0,0)"),
			(this.onEnd = c.onEnd),
			(this.onBegin = c.onBegin),
			(this._canvas = a),
	...
	(b.prototype.clear = function () {
		...
		(b.prototype._strokeBegin = function (a) {
			this._reset(),
				...
				"function" == typeof this.onBegin && this.onBegin(a);
		}),
		...
		(b.prototype._strokeEnd = function (a) {
			var b = this.points.length > 2,
				c = this.points[0];
			!b && c && this._strokeDraw(c),
				"function" == typeof this.onEnd && this.onEnd(a);
		}),
		(b.prototype._handleMouseEvents = function () {
			var b = this;
			(this._mouseButtonDown = !1),
				this._canvas.addEventListener("mousedown", function (a) {
				...
				a.addEventListener("mouseup", function (a) {
					1 === a.which &&
						b._mouseButtonDown &&
						((b._mouseButtonDown = !1), b._strokeEnd(a));
				});
		}),
		...
		(b.prototype._addPoint = function (a) {
			...
			g.push(a),
				g.length > 2 &&
					(3 === g.length && g.unshift(g[0]),
					(f = this._calculateCurveControlPoints(g[0], g[1], g[2])),
					(b = f.c2),
					(f = this._calculateCurveControlPoints(g[1], g[2], g[3])),
					(c = f.c1),
					(e = new d(g[1], b, c, g[2])),
					this._addCurve(e),
					g.shift());
		...
		(b.prototype._addCurve = function (a) {
			...
			(b = e.velocityFrom(d)),
				(b =
					this.velocityFilterWeight * b +
					(1 - this.velocityFilterWeight) * this._lastVelocity),
				(c = this._strokeWidth(b)),
		...
		(b.prototype._drawCurve = function (a, b, c) {
			var d,
				...
				o = this._ctx,
				p = c - b;
			for (d = Math.floor(a.length()), o.beginPath(), f = 0; d > f; f++)
				(g = f / d),
					(h = g * g),
					(i = h * g),
					(j = 1 - g),
					...
					(l = k * j),
					(m = l * a.startPoint.x),
					(m += 3 * k * g * a.control1.x),
					(m += 3 * j * h * a.control2.x),
					(m += i * a.endPoint.x),
					(n = l * a.startPoint.y),
					(n += 3 * k * g * a.control1.y),
					(n += 3 * j * h * a.control2.y),
					(n += i * a.endPoint.y),
					(e = b + i * p),
					this._drawPoint(m, n, e);
			o.closePath(), o.fill();
		}),
		...
		(d.prototype.length = function () {
			...
			for (a = 0; i >= a; a++)
				(b = a / i),
					...
					a > 0 && ((g = c - e), (h = d - f), (j += Math.sqrt(g * g + h * h))),
					(e = c),
					(f = d);
			return j;
		}),
