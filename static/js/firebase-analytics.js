!(function (e, t) {
	...
	try {
		!function () {
			...
			function me() {
				...
				return (
					ge ||
						...
						(n = (e = O(indexedDB, "open", [pe, e])).request) &&
			...
			function Ce(e) {
				return we(e, function (e) {
					...
					return 1 === (t = t).requestStatus && t.requestTime + B < Date.now()
						? c(c({}, e), { authToken: { requestStatus: 0 } })
						: e;
				});
			}
			function Oe(e) {
				...
				Re =
					...
					(Fe.prototype.debug = function () {
						...
						this._userLogHandler &&
							this._userLogHandler.apply(this, a([this, de.DEBUG], e)),
							this._logHandler.apply(this, a([this, de.DEBUG], e));
					}),
					(Fe.prototype.log = function () {
						for (var e = [], t = 0; t < arguments.length; t++)
							e[t] = arguments[t];
						this._userLogHandler &&
							this._userLogHandler.apply(this, a([this, de.VERBOSE], e)),
							this._logHandler.apply(this, a([this, de.VERBOSE], e));
					}),
					(Fe.prototype.info = function () {
						for (var e = [], t = 0; t < arguments.length; t++)
							e[t] = arguments[t];
						this._userLogHandler &&
							this._userLogHandler.apply(this, a([this, de.INFO], e)),
							this._logHandler.apply(this, a([this, de.INFO], e));
					}),
					(Fe.prototype.warn = function () {
						for (var e = [], t = 0; t < arguments.length; t++)
							e[t] = arguments[t];
						this._userLogHandler &&
							this._userLogHandler.apply(this, a([this, de.WARN], e)),
							this._logHandler.apply(this, a([this, de.WARN], e));
					}),
					(Fe.prototype.error = function () {
						for (var e = [], t = 0; t < arguments.length; t++)
							e[t] = arguments[t];
						this._userLogHandler &&
							this._userLogHandler.apply(this, a([this, de.ERROR], e)),
							this._logHandler.apply(this, a([this, de.ERROR], e));
					}),
					Fe);
			function Fe(e) {
				(this.name = e),
			...
			function et(e) {
				if (e instanceof u && e.customData) {
			...
			function pt(e, t) {
				(i = []),
					l() && i.push("This is a browser extension environment."),
					f() || i.push("Cookies are not available."),
					0 < i.length &&
						((i = i
							.map(function (e, t) {
								return "(" + (t + 1) + ") " + e;
				...
				if (null != at[u]) throw $e.create("already-exists", { id: u });
				return (
					ft ||
						((a = ct),
						(s = []),
						Array.isArray(window[a]) ? (s = window[a]) : (window[a] = s),
						(n = at),
						(r = st),
						(i = ut),
						(o = ct),
						...
						window[a] && "function" == typeof window[a] && (s = window[a]),
						(window[a] = We(s, n, r, i)),
						(a = { gtagCore: s, wrappedGtag: window[a] }),
						(ot = a.wrappedGtag),
						(it = a.gtagCore),
						(ft = !0)),
					(at[u] = rt(e, st, ut, t, it, ct)),
					{
						app: e,
						logEvent: function (e, t, n) {
							...
							})(ot, at[u], e, t, n).catch(function (e) {
								return Ue.error(e);
							});
						},
						...
						setAnalyticsCollectionEnabled: function (e) {
							...
							})(at[u], e).catch(function (e) {
								return Ue.error(e);
							});
						},
						INTERNAL: {
							delete: function () {
								return delete at[u], Promise.resolve();
							},
						},
					}
				);
			...
			(ht = t.default).INTERNAL.registerComponent(
				...
				ht.registerVersion("@firebase/analytics", "0.6.10");
		}.apply(this, arguments);
	} catch (e) {
		throw (
			(console.error(e),
