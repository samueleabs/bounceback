!(function (e, t) {
	...
	function me(e, t, r) {
		...
		ce(new y(`${n}-version`, () => ({ library: n, version: t }), "VERSION"));
	}
	function ve(e, t) {
	...
	(ee = ""),
		ce(new y("platform-logger", (e) => new X(e), "PRIVATE")),
		ce(new y("heartbeat", (e) => new Oe(e), "PRIVATE")),
		me(q, Z, ee),
		me(q, Z, "esm2017"),
		me("fire-js", "");
	var Be = Object.freeze({
		...
		initializeServerApp: function (e, t) {
			if (("undefined" != typeof window || d()) && !d())
				throw de.create("invalid-server-app-environment");
			void 0 === t.automaticDataCollectionEnabled &&
	...
	class Te {
		constructor(e, t) {
			(this._delegate = e),
				(this.firebase = t),
				se(e, new y("app-compat", () => this, "PUBLIC")),
	...
	const je = ke;
	me("@firebase/app-compat", "0.2.47", void 0);
	return je.registerVersion("firebase", "11.1.0", "app-compat-cdn"), je;
});
