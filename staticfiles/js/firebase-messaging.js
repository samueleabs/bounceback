				...
				return d(this, void 0, void 0, function () {
					...
					return h(this, function (e) {
						switch (e.label) {
							...
							case 7:
								return (
									e.sent(), !o || (i && i.fid === o.fid) || X(s, o.fid), [2, o]
								);
						}
					});
				});
						...
						var t = e.getProvider("app").getImmediate(),
							n = {
								appConfig: (function (e) {
									...
									try {
										for (
											var r = c(["projectId", "apiKey", "appId"]), i = r.next();
											!i.done;
											i = r.next()
										) {
											var o = i.value;
			...
			t.default.INTERNAL.registerComponent(
				new g(
					...
					function (e) {
						...
						return new (self && "ServiceWorkerGlobalScope" in self ? Xe : nt)(
							e
						);
					},
					"PUBLIC"
