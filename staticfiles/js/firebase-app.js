!(function (e, t) {
	...
	var _ = "[DEFAULT]",
		N =
			...
			(C.prototype.getImmediate = function (e) {
				...
				try {
					for (
						...
						var l = p(s.value, 2),
							c = l[0],
							l = l[1];
						i === this.normalizeInstanceIdentifier(c) && l.resolve(o);
					}
				} catch (e) {
					t = { error: e };
				} finally {
			...
			(C.prototype.invokeOnInitCallbacks = function (e, t) {
				...
				try {
					for (
						var i = u(this.onInitCallbacks), o = i.next();
						!o.done;
						o = i.next()
					) {
						var a = o.value;
	...
	(q = ee).INTERNAL.registerComponent(
		...
		q.registerVersion(V, "0.6.22", Q),
		q.registerVersion("fire-js", "");
	return ee.registerVersion("firebase", "8.6.1", "app"), ee;
});
